  ...
  <article role="main" id="Presentation" class="  ">
    ...
    <h1 class="col-12 text-center"> Annia Galano's Group</h1>
 	...
 	<div class="p-4 m1 row cardPrincipal">
       ...
       <?php CreaTargeta("Star Database",asset('img/Stra_img.jpg'),"STAR is an application and database for astrochemistry. <br>The database holds Thermochemistry theoretical information of the ground state (enthalpy and free energy) for 134 species observed in phase gas (in black) and proposed intermediaries (in gray). Currently, Thermochemistry data is calculated with the CBS-QB3 composite method. The application finds possible bimolecular chemical reactions that have potential to create a molecule in the ISM.","Data Base","http://star.agalano.com/");?>
